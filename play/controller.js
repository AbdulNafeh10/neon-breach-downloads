...
export function padActions(sample,pressed,sprint=false){return {forward:-sample.move.y,strafe:sample.move.x,lookX:sample.look.x,lookY:sample.look.y,aim:sample.buttons[6],fire:sample.buttons[7],firePress:pressed[7],jump:pressed[0],slide:pressed[1]||pressed[11],reload:pressed[2],next:pressed[3],dash:pressed[4],boost:pressed[5],sprint,menu:pressed[9],accept:pressed[0],back:pressed[1]};}
