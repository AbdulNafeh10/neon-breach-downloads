...
import {BLOCKS,WEAPONS} from './core.js';
...
export function createArena(renderer){
 ...
 for(const b of BLOCKS){
  ...
  const mat=b.kind==='crate'?copper:b.kind==='step'?steel:b.kind==='platform'?base:b.kind==='wall'?copper:b.kind==='tower'||b.kind==='rampart'?steel:light;
